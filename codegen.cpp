...
std::string CodeGenContext::generateCode(NBlock& root)
{
    ...
    */
    ...
    PassManager<Module> pm;
    //pm.addPass(createPrintModulePass(*outputStream));
    pm.addPass(PrintModulePass(*outputStream));
    pm.run(*module);
